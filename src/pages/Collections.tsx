...
const ProductsList: React.FC = () => {
  const [currentMedia, setCurrentMedia] = React.useState<"video1" | "video2">(
    "video1"
  );
  ...
  return (
    <div className="text-[#1c1c1c] min-h-screen relative">
      ...
      {/* HERO SPACER */}
      <section className="relative w-full h-[80vh] bg-transparent"></section>
        ...
        <div className="max-w-7xl mx-auto space-y-10">
          <div className="text-center border border-[#D4AF37] p-4 rounded-lg w-fit mx-auto bg-[#88876d] backdrop-blur-sm">
            ...
            <p className="text-[#1c1c1c] mt-2 max-w-2xl mx-auto">
              Select categories and click view for images, details and quotation
              support.
            </p>
          </div>
