    ...
    <div className="min-h-screen bg-[#0a0a0a] overflow-hidden text-white">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="w-full">
            ...
            >
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">{visitUsDetail.title}</h3>
                <p className="text-gray-300 font-semibold">{visitUsDetail.info}</p>
      ...
      <section className="py-20 bg-[#111] text-center text-white border-t border-[#D4AF37]/20">
        <div className="max-w-3xl mx-auto space-y-6 px-6">
          <h2 className="text-4xl font-bold">Let’s Deal Something <span className="text-[#D4AF37]">Amazing</span></h2>
