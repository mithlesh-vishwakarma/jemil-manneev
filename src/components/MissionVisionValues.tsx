...
const MissionVisionValues = () => {
  return (
    <section className="max-w-6xl mx-auto bg-white py-20 px-2 md:px-4 lg:px-0">
      {/* Main Title */}
      <motion.h2
      ...
      >
        <h2 className="text-4xl font-bold mb-4">
            Our <span className="text-gradient">Mission, Vision & Values</span>
          </h2>
      </motion.h2>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-20">
        ...
        >
          <h3 className="text-2xl font-bold text-gray-900 mb-4 underline decoration-purple-600">Our <span className="text-2xl text-gradient">Mission</span></h3>
        ...
        >
          <div className="relative animate-float">
            <div className="bg-white p-8 rounded-3xl shadow-2xl border border-purple-200 overflow-hidden">
              <img
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10 mb-20">
        ...
        >
          <h3 className="text-2xl font-bold text-gray-900 mb-4 underline decoration-purple-600">Our <span className="text-2xl text-gradient">Vision</span></h3>
          <p className="text-gray-600 leading-relaxed text-lg">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-10">
        <motion.div
          ...
          className="flex-1 text-left"
        >
         <h3 className="text-2xl font-bold text-gray-900 mb-4 underline decoration-purple-600">Our <span className="text-2xl text-gradient">Values</span></h3>
          <p className="text-gray-600 leading-relaxed text-lg">
